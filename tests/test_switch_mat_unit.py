...
class _MatDevice(FakeCoordinator):
    pass


@pytest.mark.asyncio
async def test_switch_async_setup_entry_mat_adds_mat_switches_and_common(
    hass: Any, monkeypatch: pytest.MonkeyPatch
) -> None:
    monkeypatch.setattr(platform, "ReefMatCoordinator", _MatDevice, raising=True)
    ...
    hass.data.setdefault(DOMAIN, {})[entry.entry_id] = _MatDevice()
